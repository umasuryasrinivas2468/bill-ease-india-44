...
export interface ComplianceRule {
  id: string;
  title: string;
  category: string; // GST, TDS, Payroll, MCA / ROC, Income Tax
  frequency: Frequency;
  link?: string;
  note?: string;
}
...
export const COMPLIANCE_RULES: ComplianceRule[] = [
  ...
  // MCA / ROC
  { id: 'dpt3', title: 'DPT-3', category: 'MCA', frequency: { kind: 'annual', month: 6, day: 30 }, note: 'Return of deposits / exempted outstanding receipts, if applicable to the company.', link: '#' },
  { id: 'llp_form11', title: 'LLP Form 11', category: 'MCA', frequency: { kind: 'annual', month: 5, day: 30 }, note: 'Annual return for LLPs.', link: '#' },
  { id: 'dir3_kyc', title: 'DIR-3 KYC', category: 'MCA', frequency: { kind: 'annual', month: 9, day: 30 }, note: 'Annual KYC for DIN holders / directors.', link: '#' },
  { id: 'aoc4', title: 'AOC-4 (Financial Statements)', category: 'MCA', frequency: { kind: 'annual', month: 10, day: 30 }, note: 'Company annual filing. Actual due date is tied to AGM timelines, so use this as a tracker and confirm applicability.', link: '#' },
  { id: 'llp_form8', title: 'LLP Form 8', category: 'MCA', frequency: { kind: 'annual', month: 10, day: 30 }, note: 'Statement of Account and Solvency for LLPs.', link: '#' },
  { id: 'mgt7', title: 'MGT-7 / MGT-7A (Annual Return)', category: 'MCA', frequency: { kind: 'annual', month: 11, day: 29 }, note: 'Annual return for companies. MGT-7A is generally used for OPCs and small companies.', link: '#' },
