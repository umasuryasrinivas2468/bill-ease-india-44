...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "AP Reports", url: comingSoon("AP Reports"), icon: BarChart3 },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Stock Movements", url: comingSoon("Stock Movements"), icon: Move3d },
      ...
      { title: "Inventory MIS", url: comingSoon("Inventory MIS"), icon: BarChart3 },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Accounts", url: comingSoon("Accounts"), icon: Briefcase },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "GSTR-2A/2B Reconciliation", url: comingSoon("GSTR-2A/2B Reconciliation"), icon: GitMerge },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Sub-Ledgers", url: comingSoon("Sub-Ledgers"), icon: BookOpen },
      ...
      { title: "General Ledger", url: comingSoon("General Ledger"), icon: BookOpen },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Balance Sheet", url: comingSoon("Balance Sheet"), icon: Scale },
      ...
      { title: "AP Aging", url: comingSoon("AP Aging"), icon: CalendarClock },
      { title: "AR Aging", url: comingSoon("AR Aging"), icon: CalendarClock },
      { title: "GST Reports", url: "/reports/gst-itc", icon: Percent },
      { title: "Inventory Reports", url: comingSoon("Inventory Reports"), icon: Package },
      { title: "MIS Reports", url: comingSoon("MIS Reports"), icon: PieChart },
