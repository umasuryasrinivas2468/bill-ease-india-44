...
const mcaSuggestions = [
  'Annual company filings: AOC-4 and MGT-7 or MGT-7A',
  'Director-related filing: DIR-3 KYC for each DIN holder',
  'Deposit-related filing: DPT-3 if applicable',
  'LLP annual filings: Form 11 and Form 8 for LLP entities',
  'Event-based filings: DIR-12, MGT-14, INC-22, PAS-3, SH-7',
  'Special filings when relevant: MSME-1, ADT-1, BEN-2, charge forms',
];
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between mb-6 gap-4">
          ...
          <div className="flex gap-2 items-center flex-wrap">
            ...
            <Button asChild variant="default" size="sm">
              <Link to="/compliance/mca">MCA Page</Link>
            </Button>
          </div>
        </div>
            ...
            <Card className="shadow-lg border-muted/50">
              ...
              <CardContent className="p-4 space-y-3">
                <p className="text-sm text-muted-foreground">
                  Keep only MCA or ROC-related filings here. Choose entries based on your entity type like Private Limited, OPC, LLP, or Section 8 company.
                </p>
                <div className="space-y-2">
                  {mcaSuggestions.map((item) => (
                    <div key={item} className="text-sm p-3 rounded-lg border bg-muted/20">
                      {item}
                    </div>
                  ))}
                </div>
                <p className="text-xs text-muted-foreground">
                  Suggestion: keep annual filings always, and add event-based forms only when that event actually happens.
                </p>
              </CardContent>
            </Card>
          </div>
