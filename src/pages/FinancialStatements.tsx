  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      <Tabs defaultValue="setup" className="space-y-4">
        <TabsList className="grid w-full grid-cols-4 md:grid-cols-12 gap-2">
          ...
          <TabsTrigger value="sch3-pnl" className="flex items-center gap-2">
            <Calculator className="h-4 w-4" />
            <span className="hidden md:inline">Sch III P&L</span>
          </TabsTrigger>
